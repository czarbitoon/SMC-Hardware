...
<br>
<div class="jumbotron">
	<form action="http://smchardwaremon.000webhostapp.com/mobile-server/admin-register.php" method="POST" id="forms">
		...
		<div class="form-group">
			...
			<center><div id="role_notify"></div></center>
		</div>
		<div class="form-group">
			...
			<center><div id="office_notify"></div></center>
		</div>
		<div class="form-group">
...
<script type="text/javascript">
	...
	//	$("#role_notify").html("Office Selected: " + $(this).children("option:selected").val());
	//});
	//$("#office_id").on("change", function(){
	//	$("#office_notify").html("Office Selected: " + $(this).children("option:selected").val());
	//});
	 $("#forms").on('submit', function(e){
        e.preventDefault();
        var formData = new FormData(this);
        formData.append('name', $("#name").val());
        formData.append('role', $("#user_role").children("option:selected").val());
        formData.append('office_id', $("#office_id").children("option:selected").val());
        ...
        $.ajax({
            ...
            success:function(data){
            	alert(data);
            	$.ajax({
            		url: "http://smchardwaremon.000webhostapp.com/mobile-server/admin-add-user.php",
            		method: "GET",
            		success: function(data){
            			$("#container").html("");
            			$("#container").html(data);
